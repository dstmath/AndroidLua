...
include $(CLEAR_VARS)
LUA_SRC :=$(LOCAL_PATH)/lua-5.3.5/src
LOCAL_MODULE    := lua
...
LOCAL_CFLAGS += -D"lua_getlocaledecpoint() ='.'" -DLUA_USE_C89 -DLUA_DL_DLOPEN  -DLUA_COMPAT_5_1 -DLUA_COMPAT_5_2 -DLUA_USE_LINUX
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/lua-5.3.5/src
...
LOCAL_CFLAGS += -DLUA_USE_C89 -DLUA_DL_DLOPEN  -DLUA_COMPAT_5_1 -DLUA_COMPAT_5_2 -DLUA_USE_LINUX
